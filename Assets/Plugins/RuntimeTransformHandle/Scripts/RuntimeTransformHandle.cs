...
namespace RuntimeHandle
{
    ...
    public class RuntimeTransformHandle : MonoBehaviour
    {
        ...
        void ClearView()
        {
            // Collect all handles inside the current Runtime GameObject and disable them
            foreach (Transform childHandle in transform)
            {
                childHandle.gameObject.SetActive(false);
            }
        }
